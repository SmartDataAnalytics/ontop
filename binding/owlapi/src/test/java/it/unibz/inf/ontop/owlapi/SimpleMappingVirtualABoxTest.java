...
//			log.info("Elapsed time: {}", elapsed);
			...
			assertEquals("<http://example.org/uri1>", ToStringRenderer.getInstance().render(ind1));
			assertEquals("<http://example.org/uri1>", ToStringRenderer.getInstance().render(ind2));

...
public class SQLServerDatatypeTest extends OntopTestCase {
    ...
    public SQLServerDatatypeTest(String name, String queryFileURL, String resultFileURL, String owlFileURL,
    ...
    public static Collection<Object[]> parameters() throws Exception {
        return ManifestTestUtils.parametersFromSuperManifest(
                "/testcases-docker/manifest-datatype-mssql.ttl",
                IGNORE, REGISTRY);
    }
